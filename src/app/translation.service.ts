...
export class TranslationService {
  ...
  private translations: { [key: string]: { [key: string]: string } } = {
    pt: {
      ...
      'dashboard.advancedReport': 'Relatório Avançado',
      'dashboard.simpleReport': 'Relatório Simplificado',
      'deleteAccount.title': 'Excluir Conta',
      'deleteAccount.warning': 'Esta ação é irreversível e permanente',
      'deleteAccount.confirm': 'EXCLUIR CONTA PERMANENTEMENTE',
      'common.cancel': 'Cancelar',
      'nav.navigation': 'Navegação',
      'nav.account': 'Conta',
      'nav.theme': 'Tema',
      'nav.homeDesc': 'Página inicial',
      'nav.aboutDesc': 'Sobre nós',
      'nav.servicesDesc': 'Nossos serviços',
      'nav.blogDesc': 'Artigos e insights',
      'nav.contactDesc': 'Entre em contato',
      'nav.loginDesc': 'Acesse sua conta',
      'nav.dashboardDesc': 'Painel de controle',
      'nav.profileDesc': 'Gerenciar perfil',
      'nav.settingsDesc': 'Configurações',
      'nav.reportsDesc': 'Relatórios',
      'nav.deleteAccountDesc': 'Remover conta permanentemente',
      'nav.helpDesc': 'Central de ajuda',
      ...
      'testimonials.title': 'O que as Pessoas Dizem',
    ...
    en: {
      ...
      'dashboard.advancedReport': 'Advanced Report',
      'dashboard.simpleReport': 'Simple Report',
      'deleteAccount.title': 'Delete Account',
      'deleteAccount.warning': 'This action is irreversible and permanent',
      'deleteAccount.confirm': 'DELETE ACCOUNT PERMANENTLY',
      'common.cancel': 'Cancel',
      'nav.navigation': 'Navigation',
      'nav.account': 'Account',
      'nav.theme': 'Theme',
      'nav.homeDesc': 'Home page',
      'nav.aboutDesc': 'About us',
      'nav.servicesDesc': 'Our services',
      'nav.blogDesc': 'Articles and insights',
      'nav.contactDesc': 'Get in touch',
      'nav.loginDesc': 'Access your account',
      'nav.dashboardDesc': 'Control panel',
      'nav.profileDesc': 'Manage profile',
      'nav.settingsDesc': 'Settings',
      'nav.reportsDesc': 'Reports',
      'nav.deleteAccountDesc': 'Permanently remove account',
      'nav.helpDesc': 'Help center',
