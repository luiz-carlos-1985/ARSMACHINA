...
export class TranslationService {
  ...
  private translations: { [key: string]: { [key: string]: string } } = {
    pt: {
      ...
      'login.accountDeleted': 'Esta conta foi excluída e não pode mais ser acessada',
      ...
      'dashboard.taskTitle': 'Título da Tarefa',
      'dashboard.description': 'Descrição',
      'dashboard.editTask': 'Editar Tarefa',
      'dashboard.meetingTitle': 'Título da Reunião',
      'dashboard.date': 'Data',
      'dashboard.time': 'Horário',
      'dashboard.participants': 'Participantes',
      'dashboard.separatedByComma': 'Separados por vírgula',
      'dashboard.chooseReportType': 'Escolha o tipo de relatório que deseja gerar',
      'dashboard.projectReport': 'Relatório de Projetos',
      'dashboard.projectReportDesc': 'Lista completa de todos os projetos com status e progresso',
      'dashboard.taskReport': 'Relatório de Tarefas',
      'dashboard.taskReportDesc': 'Detalhes de todas as tarefas organizadas por projeto',
      'dashboard.analyticsReport': 'Relatório de Analytics',
      'dashboard.analyticsReportDesc': 'Métricas de performance e produtividade da equipe',
      'dashboard.executiveReport': 'Relatório Executivo',
      'dashboard.executiveReportDesc': 'Visão completa com todos os dados e métricas',
      'dashboard.allIncluded': 'Tudo incluído',
      'dashboard.recommended': 'Recomendado',
      'dashboard.reportsGenerated': 'Relatórios são gerados instantaneamente e baixados automaticamente',
      'dashboard.backToDashboard': 'Voltar ao Dashboard',
    ...
    en: {
      ...
      'login.accountDeleted': 'This account has been deleted and can no longer be accessed',
      ...
      'dashboard.separatedByComma': 'Separated by comma',
      'dashboard.chooseReportType': 'Choose the type of report you want to generate',
      'dashboard.projectReport': 'Project Report',
      'dashboard.projectReportDesc': 'Complete list of all projects with status and progress',
      'dashboard.taskReport': 'Task Report',
      'dashboard.taskReportDesc': 'Details of all tasks organized by project',
      'dashboard.analyticsReport': 'Analytics Report',
      'dashboard.analyticsReportDesc': 'Performance and team productivity metrics',
      'dashboard.executiveReport': 'Executive Report',
      'dashboard.executiveReportDesc': 'Complete overview with all data and metrics',
      'dashboard.allIncluded': 'All included',
      'dashboard.recommended': 'Recommended',
      'dashboard.reportsGenerated': 'Reports are generated instantly and downloaded automatically',
