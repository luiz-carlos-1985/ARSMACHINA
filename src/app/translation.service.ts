...
export class TranslationService {
  ...
  private translations: { [key: string]: { [key: string]: string } } = {
    pt: {
      ...
      'settings.subtitle': 'Personalize sua experiência e gerencie suas preferências',
      ...
      'settings.storageUsage': 'Uso de Armazenamento',
      'settings.clearCache': 'Limpar Cache',
      'settings.clearCacheDesc': 'Remove todos os dados armazenados localmente',
      'settings.notificationTypes': 'Tipos de Notificação',
      ...
      'settings.soundNotifications': 'Sons de Notificação',
      'settings.projectNotifications': 'Notificações de Projetos',
      'settings.taskNotifications': 'Notificações de Tarefas',
      'settings.testNotifications': 'Testar Notificações',
      'settings.testNotificationsDesc': 'Enviar uma notificação de teste',
      'settings.profileVisibility': 'Visibilidade do Perfil',
      'settings.publicProfile': 'Perfil Público',
      'settings.visibleActivities': 'Atividades Visíveis',
      'settings.visibleEmail': 'Email Visível',
      'settings.shareAnonymousData': 'Compartilhar Dados Anônimos',
      'settings.autoRefresh': 'Atualização Automática',
      'settings.refreshInterval': 'Intervalo de Atualização (segundos)',
      'settings.interface': 'Interface',
      'settings.showAnimations': 'Mostrar Animações',
      ...
      'settings.sessionTimeout': 'Timeout da Sessão (minutos)',
      'settings.loginAlerts': 'Alertas de Login',
      'settings.passwordExpiry': 'Expiração de Senha (dias)',
      'settings.experimentalFeatures': 'Recursos Experimentais',
      'settings.debugMode': 'Modo Debug',
      'settings.betaFeatures': 'Recursos Beta',
      'settings.dataCollection': 'Coleta de Dados de Uso',
      'settings.backupRestore': 'Backup e Restauração',
      'settings.exportBackup': 'Exportar Backup Completo',
      'settings.exportBackupDesc': 'Inclui todas as configurações, perfil e dados',
      'settings.importBackup': 'Importar Backup',
      'settings.importBackupDesc': 'Restaurar dados de um backup anterior',
      ...
      'dashboard.clientManagement': 'Gestão de Clientes',
      'dashboard.manageClients': 'Gerenciar Clientes',
      'dashboard.contractUntil': 'Contrato até',
      'dashboard.financialOverview': 'Visão Financeira',
      ...
      'dashboard.teamPerformanceTitle': 'Performance da Equipe',
      'dashboard.viewTeam': 'Ver Equipe',
      'dashboard.efficiency': 'Eficiência',
      'dashboard.support': 'Suporte',
      'dashboard.liveChat': 'Chat ao Vivo',
      'dashboard.immediateResponse': 'Resposta imediata',
      'dashboard.email': 'Email',
      'dashboard.response24h': 'Resposta em 24h',
      'dashboard.phoneWhatsapp': 'Telefone e WhatsApp',
      ...
      'dashboard.projectReportDesc': 'Lista completa de todos os projetos com status, progresso e prazos detalhados',
      'dashboard.taskReport': 'Relatório de Tarefas',
      'dashboard.taskReportDesc': 'Todas as tarefas com prioridades, status e associações a projetos específicos',
      'dashboard.analyticsReport': 'Relatório de Analytics',
      'dashboard.analyticsReportDesc': 'Métricas avançadas de produtividade, performance da equipe e satisfação',
      'dashboard.executiveReport': 'Relatório Executivo Completo',
      'dashboard.executiveReportDesc': 'Dashboard executivo com todos os dados, gráficos interativos e insights estratégicos',
      'dashboard.recommended': 'Recomendado',
      'dashboard.allIncluded': 'Tudo incluído',
      'dashboard.reportsGenerated': 'Relatórios gerados instantaneamente e baixados automaticamente',
      ...
      'dashboard.deadline': 'Data de Entrega',
      ...
      'dashboard.noProject': 'Nenhum projeto',
      'dashboard.priority': 'Prioridade',
      'dashboard.dueDate': 'Data de Vencimento',
      'dashboard.low': 'Baixa',
      'dashboard.medium': 'Média',
      'dashboard.high': 'Alta',
      ...
      'dashboard.planning': 'Planejamento',
      'dashboard.inProgress': 'Em Andamento',
      'dashboard.review': 'Em Revisão',
      'dashboard.createNewProject': 'Criar um novo projeto',
      'dashboard.addNewTask': 'Adicionar nova tarefa',
      'dashboard.scheduleNewMeeting': 'Agendar reunião',
      'dashboard.generateNewReport': 'Gerar relatório',

      // Projects
      'projects.title': 'Todos os Projetos',
      'projects.subtitle': 'Gerencie e acompanhe todos os seus projetos em um só lugar',
      ...
      'projects.ascending': 'Crescente',
      'projects.descending': 'Decrescente',
      ...
      'projects.days': 'dias',
      'projects.daysLate': 'dias atrasado',
      'projects.noProjectsFound': 'Nenhum projeto encontrado',
      'projects.adjustFilters': 'Tente ajustar os filtros ou termos de busca',
    ...
    en: {
      ...
      'settings.clearCacheDesc': 'Remove all locally stored data',
      ...
      'settings.projectNotifications': 'Project Notifications',
      'settings.taskNotifications': 'Task Notifications',
      'settings.testNotifications': 'Test Notifications',
      'settings.testNotificationsDesc': 'Send a test notification',
      'settings.profileVisibility': 'Profile Visibility',
      'settings.publicProfile': 'Public Profile',
      'settings.visibleActivities': 'Visible Activities',
      'settings.visibleEmail': 'Visible Email',
      'settings.shareAnonymousData': 'Share Anonymous Data',
      'settings.autoRefresh': 'Auto Refresh',
      'settings.refreshInterval': 'Refresh Interval (seconds)',
      'settings.interface': 'Interface',
      'settings.showAnimations': 'Show Animations',
      ...
      'settings.dataCollection': 'Usage Data Collection',
      'settings.backupRestore': 'Backup and Restore',
      'settings.exportBackup': 'Export Complete Backup',
      'settings.exportBackupDesc': 'Includes all settings, profile and data',
      'settings.importBackup': 'Import Backup',
      'settings.importBackupDesc': 'Restore data from a previous backup',
      ...
      'dashboard.contractUntil': 'Contract until',
      ...
      'dashboard.teamPerformanceTitle': 'Team Performance',
      'dashboard.viewTeam': 'View Team',
      'dashboard.efficiency': 'Efficiency',
      'dashboard.support': 'Support',
      'dashboard.liveChat': 'Live Chat',
      'dashboard.immediateResponse': 'Immediate response',
      'dashboard.email': 'Email',
      'dashboard.response24h': '24h response',
      'dashboard.phoneWhatsapp': 'Phone and WhatsApp',
      ...
      'dashboard.projectReportDesc': 'Complete list of all projects with detailed status, progress and deadlines',
      'dashboard.taskReport': 'Task Report',
      'dashboard.taskReportDesc': 'All tasks with priorities, status and associations to specific projects',
      'dashboard.analyticsReport': 'Analytics Report',
      'dashboard.analyticsReportDesc': 'Advanced metrics of productivity, team performance and satisfaction',
      'dashboard.executiveReport': 'Complete Executive Report',
      'dashboard.executiveReportDesc': 'Executive dashboard with all data, interactive charts and strategic insights',
      'dashboard.recommended': 'Recommended',
      'dashboard.allIncluded': 'Everything included',
      'dashboard.reportsGenerated': 'Reports generated instantly and downloaded automatically',
      ...
      'dashboard.createNewProject': 'Create a new project',
      'dashboard.addNewTask': 'Add new task',
      'dashboard.scheduleNewMeeting': 'Schedule meeting',
      'dashboard.generateNewReport': 'Generate report',

      // Projects
      'projects.title': 'All Projects',
      'projects.subtitle': 'Manage and track all your projects in one place',
      ...
      'projects.ascending': 'Ascending',
      'projects.descending': 'Descending',
      ...
      'projects.days': 'days',
      'projects.daysLate': 'days late',
      'projects.noProjectsFound': 'No projects found',
      'projects.adjustFilters': 'Try adjusting filters or search terms',
