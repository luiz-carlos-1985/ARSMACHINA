...
export class TranslationService {
  ...
  private translations: { [key: string]: { [key: string]: string } } = {
    pt: {
      ...
      'resetPassword.emailSent': 'E-mail enviado! Verifique sua caixa de entrada.',
      'resetPassword.enterEmail': 'Por favor, digite seu e-mail.',
      'resetPassword.error': 'Erro ao enviar e-mail. Tente novamente.',
      ...
      'resetPassword.fillAllFields': 'Por favor, preencha todos os campos.',
    ...
    en: {
      ...
      'resetPassword.emailSent': 'Email sent! Check your inbox.',
      'resetPassword.enterEmail': 'Please enter your email.',
      'resetPassword.error': 'Error sending email. Please try again.',
